...
export default function AIAnalyticsLockedPage() {
    ...
    const handleUpgradeClick = () => {
        ...
        fetch('/api/admin/feature-requests', {
            ...
            body: JSON.stringify({
                featureTitle: 'AI-Powered Business Intelligence',
                price,
                action: 'click'
            })
        }).catch(() => {});
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '85vh', px: 2, py: 4 }}>
            ...
            >
                <DialogTitle sx={{ fontWeight: 800, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    {success ? 'Activation Initiated' : 'Unlock AI Business Analytics'}
                    ...
                    {success ? (
                        <Box sx={{ textAlign: 'center', py: 3, px: 1 }}>
                            ...
                            <Typography variant="body2" sx={{ color: '#64748b', lineHeight: 1.6 }}>
                                Your activation ticket for <strong>AI-Powered Business Intelligence</strong> has been successfully registered. The dev team is provisioning a dedicated container for this feature node.
                            </Typography>
                        </Box>
                    ) : (
